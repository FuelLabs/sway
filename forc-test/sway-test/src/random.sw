...
/// Generate random bytes using a non-deterministic random source
///
/// # Arguments
...
/// Generate random bytes using a seeded deterministic random source
///
/// # Arguments
/// * `buffer_ptr` - Pointer to the buffer
/// * `count` - Number of bytes to generate
...
/// Generate a random u64 value from a seed
...
/// Generate a random u8 value from a seed
