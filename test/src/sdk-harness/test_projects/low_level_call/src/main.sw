...
fn main(target: ContractId) {
    ...
    require(test_u64(target), TestCaseError::U64);
    require(test_b256(target), TestCaseError::B256);

}

fn test_u64(target: ContractId) -> bool {
...
fn test_b256(target: ContractId) -> bool {
