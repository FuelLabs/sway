...
async fn can_get_predicate_address() {
    ...
    let hex_predicate_address: &str =
        "0x1912f429c2349baa508c97abe464747268676e563c1558de28d223c13edde85f"; // AUTO-PREDICATE-ID auth_predicate test/src/sdk-harness --output-directory test/src/sdk-harness/out
