...
async fn valid_predicate_data_simple() {
    ...
    let predicate_code = std::fs::read("test_projects/predicate_data_simple/out/debug/predicate_data_simple.bin");
    ...
    let predicate_data = hex::decode("ef86afa9696cf0dc6385e2c407a6e159a1103cefb7e2ae0636fb33d3cb2a9e4a").unwrap();
    ...
    let receiver_address = Address::from_str("0xde97d8624a438121b86a1956544bd72ed68cd69f2c99555b08b1e8c51ffd511c")
            .unwrap();
...
async fn invalid_predicate_data_simple() {
    let amount_to_predicate = 1000;
    let asset_id = AssetId::default();
    let bin = std::fs::read("test_projects/predicate_data_simple/out/debug/predicate_data_simple.bin");
    let predicate_hash = (*Contract::root_from_code(&predicate_code)).into();
    let secret_key = SecretKey::from_str("0x976e5c3fa620092c718d852ca703b6da9e3075b9f2ecb8ed42d9f746bf26aafb")
        .unwrap();
    ...
    let predicate_data = hex::decode("badbadbadbadbadbadbadbadbadbadbadbadbadbadbadbadbadbadbadbadbada").unwrap();
