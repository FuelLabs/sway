use fuels::{prelude::*, tx::ContractId, types::core::Bits256};
// Load abi from json
abigen!(Contract(
    name = "MyContract",
...
pub mod wrappers {
    ...
    pub async fn pop(instance: &MyContract) -> [u8; 32] {
        instance.methods().b256_pop().call().await.unwrap().value.0
    }
    ...
    pub async fn insert(instance: &MyContract, index: u64, value: [u8; 32]) {
        instance
            .methods()
            .b256_insert(index, Bits256(value))
            .call()
            .await
            .unwrap();
    }
    ...
    pub async fn len(instance: &MyContract) -> u64 {
        instance.methods().b256_len().call().await.unwrap().value
    }
    ...
    pub async fn clear(instance: &MyContract) {
        instance.methods().b256_clear().call().await.unwrap();
    }
}
