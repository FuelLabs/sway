...
impl ExperimentalStorageTest for Contract {
    ...
    fn nested_map_1_access() {
        ...
        // Map insert via `[]`
        storage.nested_map_1[1][0][0] = 5;
        storage.nested_map_1[1][0][1] = 6;
        storage.nested_map_1[1][1][0] = 7;
        storage.nested_map_1[1][1][1] = 8;
    ...
    fn nested_map_2_access() {
        ...
        storage.nested_map_2[(1, 0)]["0001"][1] = m2;
        storage.nested_map_2[(1, 1)]["0000"][0] = m1;
        storage.nested_map_2[(1, 1)]["0001"][1] = m2;
    ...
    fn nested_map_3_access() {
        ...
        // Map insert via `[]`
        storage.nested_map_3[1][m1][0] = e1;
        storage.nested_map_3[1][m2][1] = e2;
        storage.nested_map_3[1][m1][0] = e1;
        storage.nested_map_3[1][m2][1] = e2;
