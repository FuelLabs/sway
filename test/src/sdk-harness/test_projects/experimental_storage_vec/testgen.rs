#[macro_export]
macro_rules! experimental_storage_vec_testgen {
    (
            ...
            pub mod setup {
                ...
                pub async fn get_contract_instance() -> MyContract {
                    ...
                    let id = Contract::deploy(
                        &format!(
                            "test_artifacts/experimental_storage_vec/svec_{}/out/debug/svec_{}.bin",
                            $type_label,
                            $type_label,
                        ),
                        &wallet,
                        ...
                        StorageConfiguration::with_storage_path(Some(
                            format!(
                                "test_artifacts/experimental_storage_vec/svec_{}/out/debug/svec_{}-storage_slots.json",
                                $type_label,
                                $type_label,
                            ),
                        )),
