...
// check: $(=^\s*)pub fn initialize<557ac400>(initial_value $MD: u64) -> u64, $(init_md=$MD) {
// check: $(=^\s*)pub fn increment<e543c666>(increment_by $MD: u64) -> u64, $(increment_md=$MD) {
// check: $(=^\s*)pub fn get<75b70457>() -> u64, $(get_md=$MD) {
