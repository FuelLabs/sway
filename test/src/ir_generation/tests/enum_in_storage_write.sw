...
// check: $(key_0_0_var=$VAL) = get_local b256 key_for_0_0
...
// check: $(key_0_1_var=$VAL) = get_local b256 key_for_0_1
...
// check: $(val_0_1_var=$VAL) = get_local [b256; 2] val_for_0_1
// check: $(cast_val_0_1=$VAL) = cast_ptr $val_0_1_var, ( { u64, u64, u64, u64, u64 } | u64 ), 0
// check: store $enum_val to $cast_val_0_1
// check: $(val_0_1_var_b256=$VAL) = get_local [b256; 2] val_for_0_1
// check: $(cast_val_0_1_var_b256=$VAL) = cast_ptr $val_0_1_var_b256, b256, 0
