...
// check: $(tmp_ptr_rep=$VAL) = get_local __ptr { u64, u64, u64 }, $(=__aggr_memcpy_\d+)
// check: $(idx_val=$VAL) = const u64 1
// check: $(field_val=$VAL) = get_elem_ptr $tmp_ptr_rep, __ptr u64, $idx_val
...
// fn a()...
//
// check: fn $a_func($ID $MD: bool, $ID $MD: u64, $ID $MD: u64, $(ret_val_arg=$ID): __ptr { u64, u64, u64 }) -> __ptr { u64, u64, u64 }
// check: cbr $ID, $(block_0=$ID)(), $(block_1=$ID)()

// check: $block_0():
// check: mem_copy_val $ret_val_arg, $VAL
// check: ret __ptr { u64, u64, u64 } $ret_val_arg
