...
// check: contract {
// check: fn get_b256<42123b96>($ID $MD: ptr b256, $ID: ptr b256) -> ptr b256,
// check: fn get_s<fc62d029>($ID $MD: u64, $ID $MD: ptr b256, $ID: ptr { u64, b256 }) -> ptr { u64, b256 }
...
// check: .data:
// check: data_2 .word 1108491158
// check: data_3 .word 4234334249
// check: data_4 .word 2559618804
