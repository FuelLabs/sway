...
fn main() -> bool {
    let a = [false, true, false, false];
    a[1]
}

// ::check-ir::

// check: local [bool; 4] __array_init_0
// check: local [bool; 4] a

// check: $(ptr_array_init=$VAL) = get_local __ptr [bool; 4], __array_init_0
// check: $(c_false_1=$VAL) = const bool false
// check: $(c_true_2=$VAL) = const bool true
// check: $(c_false_3=$VAL) = const bool false
// check: $(c_false_4=$VAL) = const bool false
// check: $(ptr_init_aggr=$VAL) = init_aggr $ptr_array_init [$c_false_1, $c_true_2, $c_false_3, $c_false_4]
// check: $(loaded_init_aggr=$VAL) = load $ptr_init_aggr
// check: $(ptr_a=$VAL) = get_local __ptr [bool; 4], a
