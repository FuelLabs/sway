...
fn identity_eq() {
    ...
    assert_eq(contract_id3, contract_id4);
    assert_eq(address5, address6);
    assert_eq(contract_id5, contract_id6);
}
...
fn identity_ne() {
    ...
    assert_ne(contract_id1, contract_id4);
    assert_ne(contract_id1, contract_id5);
    assert_ne(contract_id1, contract_id6);
    assert_ne(contract_id2, contract_id3);
    assert_ne(contract_id2, contract_id4);
    assert_ne(contract_id2, contract_id5);
    assert_ne(contract_id2, contract_id6);
    assert_ne(contract_id3, contract_id5);
    assert_ne(contract_id3, contract_id6);
    assert_ne(contract_id4, contract_id5);
    assert_ne(contract_id4, contract_id6);

    assert_ne(address1, contract_id1);
    assert_ne(address1, contract_id2);
    assert_ne(address1, contract_id3);
    assert_ne(address1, contract_id4);
    assert_ne(address1, contract_id5);
    assert_ne(address1, contract_id6);
    assert_ne(address2, contract_id1);
    assert_ne(address2, contract_id2);
    assert_ne(address2, contract_id3);
    assert_ne(address2, contract_id4);
    assert_ne(address2, contract_id5);
    assert_ne(address2, contract_id6);
    assert_ne(address3, contract_id1);
    assert_ne(address3, contract_id2);
    assert_ne(address3, contract_id3);
    assert_ne(address3, contract_id4);
    assert_ne(address3, contract_id5);
    assert_ne(address3, contract_id6);
    assert_ne(address4, contract_id1);
    assert_ne(address4, contract_id2);
    assert_ne(address4, contract_id3);
    assert_ne(address4, contract_id4);
    assert_ne(address4, contract_id5);
    assert_ne(address4, contract_id6);
    assert_ne(address5, contract_id1);
    assert_ne(address5, contract_id2);
    assert_ne(address5, contract_id3);
    assert_ne(address5, contract_id4);
    assert_ne(address5, contract_id5);
    assert_ne(address5, contract_id6);
    assert_ne(address6, contract_id1);
    assert_ne(address6, contract_id2);
    assert_ne(address6, contract_id3);
    assert_ne(address6, contract_id4);
    assert_ne(address6, contract_id5);
    assert_ne(address6, contract_id6);
}
...
fn identity_as_address() {
    ...
    assert_eq(address1.as_address().unwrap(), Address::zero());
    ...
    assert_eq(
        address3
            .as_address()
            .unwrap(),
        Address::from(0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF),
    );
...
fn identity_as_contract_id() {
    ...
    assert_eq(contract_id1.as_contract_id().unwrap(), ContractId::zero());
    ...
    assert_eq(
        contract_id3
            .as_contract_id()
            .unwrap(),
        ContractId::from(0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF),
    );
}
...
fn identity_bits() {
    ...
    assert_eq(address1.bits(), b256::zero());
    assert_eq(contract_id1.bits(), b256::zero());
    assert_eq(
        address2
            .bits(),
...
fn identity_hash() {
    ...
    assert_eq(
        sha256(address1),
        0x7f9c9e31ac8256ca2f258583df262dbc7d6f68f2a03043d5c99a4ae5a7396ce9,
    );
    assert_eq(
        sha256(contract_id1),
    ...
    assert_eq(
        sha256(contract_id2),
        0x2e255099d6d6bee307c8e7075acc78f949897c5f67b53adf60724c814d7b90cb,
    );
    assert_eq(
        sha256(address3),
        0x5e16d316ecd5773e50c3b02737d424192b02f25b4245822079181c557aafda7d,
    );
    assert_eq(
        sha256(contract_id3),
        0x29fb7cd3be48a8d76bb031f0abce26caa9e092c000cd16bb101d30f63c4c1bc1,
    );
}
