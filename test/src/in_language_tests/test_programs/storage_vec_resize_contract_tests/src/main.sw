...
impl Contract {
    ...
    fn assert_resize() {
        ...
        assert_resize_impl::<str[6]>(11);
        assert_resize_impl::<str[8]>(12);
        assert_resize_impl::<str[12]>(13);
        assert_resize_impl::<[u64; 2]>(14);
        assert_resize_impl::<ArrayU8Len2>(15);
        assert_resize_impl::<ArrayU64Len3>(16);
        assert_resize_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_resize_impl::<ArrayStructBLen2>(18);
        assert_resize_impl::<RawPtrNewtype>(19);
        assert_resize_impl::<StructA>(20);
        assert_resize_impl::<StructB>(21);
        assert_resize_impl::<EnumSingleU8>(22);
        assert_resize_impl::<EnumSingleU64>(23);
        assert_resize_impl::<EnumSingleBool>(24);
        assert_resize_impl::<EnumMultiUnits>(25);
        assert_resize_impl::<EnumMultiOneByte>(26);
        assert_resize_impl::<EnumU8AndU64>(27);
        assert_resize_impl::<EnumQuadSlotSize>(28);
        assert_resize_impl::<EnumLargerThanQuadSlot>(29);
        assert_resize_impl::<(u8, u32)>(30);
    }
