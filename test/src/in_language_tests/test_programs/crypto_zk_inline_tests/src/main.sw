...
use std::crypto::{point2d::*, scalar::*, zk::{ec_add, ec_mul, CurveType, ec_pairing_check}};
...
fn zk_ec_add() {
    ...
    let result_1 = ec_add(CurveType::AltBN128, p1_1, p2_1);
    ...
    let result_2 = ec_add(CurveType::AltBN128, p1_2, p2_2);
    ...
    let result_3 = ec_add(CurveType::AltBN128, p1_3, p2_3);
    ...
    let result_4 = ec_add(CurveType::AltBN128, p1_4, p2_4);
    ...
    let result_5 = ec_add(CurveType::AltBN128, p1_5, p2_5);
    assert(result_5 == expected_point_5);
}

#[test(should_revert)]
fn revert_zk_ec_add_fail() {
    // From https://github.com/bluealloy/revm/blob/main/crates/precompile/src/bn128.rs
    ...
    let _result = ec_add(CurveType::AltBN128, p1, p2);
}

// TODO: Uncomment and implement test when another curve is supported
// #[test(should_revert)]
// fn revert_zk_ec_add_invalid_point() {
...
fn zk_ec_mul() {
    ...
    let result_1 = ec_mul(CurveType::AltBN128, p1_1, scalar_1);
    assert(result_1 == expected_point_1);
    ...
    let result_2 = ec_mul(CurveType::AltBN128, p1_2, scalar_2);
    assert(result_2 == expected_point_2);
    ...
    let result_3 = ec_mul(CurveType::AltBN128, p1_3, scalar_3);
    assert(result_3 == expected_point_3);
    ...
    let result_4 = ec_mul(CurveType::AltBN128, p1_4, scalar_4);
    assert(result_4 == expected_point_4);
    ...
    let result_5 = ec_mul(CurveType::AltBN128, p1_5, scalar_5);
    assert(result_5 == expected_point_5);
}

#[test(should_revert)]
fn revert_zk_ec_mul_fail() {
    // From https://github.com/bluealloy/revm/blob/main/crates/precompile/src/bn128.rs
    ...
    let _result = ec_mul(CurveType::AltBN128, p, scalar);
}

// TODO: Uncomment and implement test when another curve is supported
// #[test(should_revert)]
// fn revert_zk_ec_mul_invalid_point() {
...
// TODO: Uncomment and implement test when another curve is supported
// #[test(should_revert)]
// fn revert_zk_ec_mul_invalid_scalar() {
...
fn zk_ec_pairing_check() {
    ...
    assert(ec_pairing_check(CurveType::AltBN128, points_vec_1));
    ...
    assert(ec_pairing_check(CurveType::AltBN128, points_vec_2));
    ...
    assert(!ec_pairing_check(CurveType::AltBN128, points_vec_3));
    ...
    assert(ec_pairing_check(CurveType::AltBN128, points_vec_4));
}

#[test(should_revert)]
fn revert_zk_ec_pairing_check() {
    ...
    let _ = ec_pairing_check(CurveType::AltBN128, points_vec);
}
