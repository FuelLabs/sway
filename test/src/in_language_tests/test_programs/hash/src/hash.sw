...
#[cfg(experimental_new_hashing = false)]
#[test]
fn hash_sha256_equivalence() {
    // Arrays and tuples.
    assert_eq(sha256([1, 2, 3]), sha256((1, 2, 3)));

    // String slices.
    assert_eq(sha256(("abc", "def")), sha256(("ab", "cd", "ef")));

    // String arrays.
    assert_eq(
        sha256((__to_str_array("abc"), __to_str_array("def"))),
        sha256((__to_str_array("ab"), __to_str_array("cd"), __to_str_array("ef"))),
    );
}
...
fn hash_sha256_equivalence() {
    // Arrays and tuples.
    assert_ne(sha256([1, 2, 3]), sha256((1, 2, 3)));
    assert_eq(sha256([1, 2, 3]), sha256((3_u64, 1, 2, 3)));

    // String slices.
    assert_ne(sha256(("abc", "def")), sha256(("ab", "cd", "ef")));
    assert_eq(
        sha256(("abc", "def")),
