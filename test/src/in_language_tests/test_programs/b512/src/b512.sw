...
fn b512_eq() {
    ...
    assert_eq(b512_1, b512_2);
    assert_eq(b512_3, b512_4);
    assert_eq(b512_5, b512_6);
}
...
fn b512_ne() {
    ...
    assert_ne(b512_1, b512_3);
    assert_ne(b512_1, b512_4);
    assert_ne(b512_1, b512_5);
    assert_ne(b512_1, b512_6);
    assert_ne(b512_2, b512_3);
    assert_ne(b512_2, b512_4);
    assert_ne(b512_2, b512_5);
    assert_ne(b512_2, b512_6);
    assert_ne(b512_3, b512_5);
    assert_ne(b512_3, b512_6);
}
...
fn b512_try_from_bytes() {
    ...
    assert_eq(b512_3.unwrap(), B512::zero());
    ...
    assert_eq(b512_4.unwrap(), B512::from((b256::max(), b256::max())));
    ...
    assert_eq(b512_6.unwrap(), B512::zero());
    bytes_6.set(0, 255u8);
    assert_eq(b512_6.unwrap(), B512::zero());
}
...
fn b512_into_bytes() {
    ...
    assert_eq(bytes_1.capacity(), 64);
    assert_eq(bytes_1.len(), 64);
    let mut iter_1 = 0;
    while iter_1 < 64 {
    ...
    assert_eq(bytes_2.capacity(), 64);
    assert_eq(bytes_2.len(), 64);
    let mut iter_2 = 0;
    while iter_2 < 64 {
    ...
    assert_eq(bytes_3.len(), 64);
    assert_eq(bytes_3.get(63).unwrap(), 1u8);
    let mut iter_3 = 0;
    while iter_3 < 63 {
...
// Helper to prove contiguity of memory in `B512`'s `hi` and `lo` fields.
...
fn b512_memory_contiguity() {
    ...
    assert(are_fields_contiguous(b));
}
