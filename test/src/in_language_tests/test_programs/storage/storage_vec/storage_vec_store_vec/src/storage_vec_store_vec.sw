...
impl Contract {
    ...
    fn assert_store_vec() {
        ...
        assert_store_vec_impl::<str[5]>(11);
        assert_store_vec_impl::<str[6]>(12);
        assert_store_vec_impl::<str[8]>(13);
        assert_store_vec_impl::<str[12]>(14);
        assert_store_vec_impl::<str[13]>(15);
        assert_store_vec_impl::<[u64; 2]>(16);
        assert_store_vec_impl::<ArrayU8Len2>(17);
        assert_store_vec_impl::<ArrayU8Len5>(18);
        assert_store_vec_impl::<ArrayU8Len6>(19);
        assert_store_vec_impl::<ArrayU8Len8>(20);
        assert_store_vec_impl::<ArrayU8Len12>(21);
        assert_store_vec_impl::<ArrayU8Len13>(22);
        assert_store_vec_impl::<ArrayU64Len3>(23);
        assert_store_vec_impl::<ArrayNestedArrayU8Len2Len3>(24);
        assert_store_vec_impl::<ArrayStructBLen2>(25);
        assert_store_vec_impl::<RawPtrNewtype>(26);
        assert_store_vec_impl::<StructA>(27);
        assert_store_vec_impl::<StructB>(28);
        assert_store_vec_impl::<EnumSingleU8>(29);
        assert_store_vec_impl::<EnumSingleU64>(30);
        assert_store_vec_impl::<EnumSingleBool>(31);
        assert_store_vec_impl::<EnumMultiUnits>(32);
        assert_store_vec_impl::<EnumMultiOneByte>(33);
        assert_store_vec_impl::<EnumU8AndU64>(34);
        assert_store_vec_impl::<EnumQuadSlotSize>(35);
        assert_store_vec_impl::<EnumLargerThanQuadSlot>(36);
        assert_store_vec_impl::<(u8, u32)>(37);
    }
...
#[test]
fn store_vec() {
    let caller = abi(StorageVecStoreVecAbi, CONTRACT_ID);
