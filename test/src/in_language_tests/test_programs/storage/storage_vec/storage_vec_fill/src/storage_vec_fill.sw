...
impl Contract {
    ...
    fn assert_fill() {
        ...
        assert_fill_impl::<str[5]>(11);
        assert_fill_impl::<str[6]>(12);
        assert_fill_impl::<str[8]>(13);
        assert_fill_impl::<str[12]>(14);
        assert_fill_impl::<str[13]>(15);
        assert_fill_impl::<[u64; 2]>(16);
        assert_fill_impl::<ArrayU8Len2>(17);
        assert_fill_impl::<ArrayU8Len5>(18);
        assert_fill_impl::<ArrayU8Len6>(19);
        assert_fill_impl::<ArrayU8Len8>(20);
        assert_fill_impl::<ArrayU8Len12>(21);
        assert_fill_impl::<ArrayU8Len13>(22);
        assert_fill_impl::<ArrayU64Len3>(23);
        assert_fill_impl::<ArrayNestedArrayU8Len2Len3>(24);
        assert_fill_impl::<ArrayStructBLen2>(25);
        assert_fill_impl::<RawPtrNewtype>(26);
        assert_fill_impl::<StructA>(27);
        assert_fill_impl::<StructB>(28);
        assert_fill_impl::<EnumSingleU8>(29);
        assert_fill_impl::<EnumSingleU64>(30);
        assert_fill_impl::<EnumSingleBool>(31);
        assert_fill_impl::<EnumMultiUnits>(32);
        assert_fill_impl::<EnumMultiOneByte>(33);
        assert_fill_impl::<EnumU8AndU64>(34);
        assert_fill_impl::<EnumQuadSlotSize>(35);
        assert_fill_impl::<EnumLargerThanQuadSlot>(36);
        assert_fill_impl::<(u8, u32)>(37);
    }
...
#[test]
fn fill() {
    let caller = abi(StorageVecFillAbi, CONTRACT_ID);
    caller.assert_fill();
}
