...
impl Contract {
    ...
    fn assert_swap() {
        ...
        assert_swap_impl::<str[5]>(11);
        assert_swap_impl::<str[6]>(12);
        assert_swap_impl::<str[8]>(13);
        assert_swap_impl::<str[12]>(14);
        assert_swap_impl::<str[13]>(15);
        assert_swap_impl::<[u64; 2]>(16);
        assert_swap_impl::<ArrayU8Len2>(17);
        assert_swap_impl::<ArrayU8Len5>(18);
        assert_swap_impl::<ArrayU8Len6>(19);
        assert_swap_impl::<ArrayU8Len8>(20);
        assert_swap_impl::<ArrayU8Len12>(21);
        assert_swap_impl::<ArrayU8Len13>(22);
        assert_swap_impl::<ArrayU64Len3>(23);
        assert_swap_impl::<ArrayNestedArrayU8Len2Len3>(24);
        assert_swap_impl::<ArrayStructBLen2>(25);
        assert_swap_impl::<RawPtrNewtype>(26);
        assert_swap_impl::<StructA>(27);
        assert_swap_impl::<StructB>(28);
        assert_swap_impl::<EnumSingleU8>(29);
        assert_swap_impl::<EnumSingleU64>(30);
        assert_swap_impl::<EnumSingleBool>(31);
        assert_swap_impl::<EnumMultiUnits>(32);
        assert_swap_impl::<EnumMultiOneByte>(33);
        assert_swap_impl::<EnumU8AndU64>(34);
        assert_swap_impl::<EnumQuadSlotSize>(35);
        assert_swap_impl::<EnumLargerThanQuadSlot>(36);
        assert_swap_impl::<(u8, u32)>(37);
    }
...
#[test]
fn swap() {
    let caller = abi(StorageVecSwapAbi, CONTRACT_ID);
    caller.assert_swap();
}
