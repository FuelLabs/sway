...
impl Contract {
    ...
    fn assert_insert() {
        ...
        assert_insert_impl::<str[5]>(11);
        assert_insert_impl::<str[6]>(12);
        assert_insert_impl::<str[8]>(13);
        assert_insert_impl::<str[12]>(14);
        assert_insert_impl::<str[13]>(15);
        assert_insert_impl::<[u64; 2]>(16);
        assert_insert_impl::<ArrayU8Len2>(17);
        assert_insert_impl::<ArrayU8Len5>(18);
        assert_insert_impl::<ArrayU8Len6>(19);
        assert_insert_impl::<ArrayU8Len8>(20);
        assert_insert_impl::<ArrayU8Len12>(21);
        assert_insert_impl::<ArrayU8Len13>(22);
        assert_insert_impl::<ArrayU64Len3>(23);
        assert_insert_impl::<ArrayNestedArrayU8Len2Len3>(24);
        assert_insert_impl::<ArrayStructBLen2>(25);
        assert_insert_impl::<RawPtrNewtype>(26);
        assert_insert_impl::<StructA>(27);
        assert_insert_impl::<StructB>(28);
        assert_insert_impl::<EnumSingleU8>(29);
        assert_insert_impl::<EnumSingleU64>(30);
        assert_insert_impl::<EnumSingleBool>(31);
        assert_insert_impl::<EnumMultiUnits>(32);
        assert_insert_impl::<EnumMultiOneByte>(33);
        assert_insert_impl::<EnumU8AndU64>(34);
        assert_insert_impl::<EnumQuadSlotSize>(35);
        assert_insert_impl::<EnumLargerThanQuadSlot>(36);
        assert_insert_impl::<(u8, u32)>(37);
    }
...
#[test]
fn insert() {
    let caller = abi(StorageVecInsertAbi, CONTRACT_ID);
