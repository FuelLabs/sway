...
impl Contract {
    ...
    fn assert_push_pop_get_len_first_last_is_empty() {
        ...
        assert_push_pop_get_len_first_last_is_empty_impl::<str[5]>(11);
        assert_push_pop_get_len_first_last_is_empty_impl::<str[6]>(12);
        assert_push_pop_get_len_first_last_is_empty_impl::<str[8]>(13);
        assert_push_pop_get_len_first_last_is_empty_impl::<str[12]>(14);
        assert_push_pop_get_len_first_last_is_empty_impl::<str[13]>(15);
        assert_push_pop_get_len_first_last_is_empty_impl::<[u64; 2]>(16);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayU8Len2>(17);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayU8Len5>(18);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayU8Len6>(19);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayU8Len8>(20);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayU8Len12>(21);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayU8Len13>(22);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayU64Len3>(23);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayNestedArrayU8Len2Len3>(24);
        assert_push_pop_get_len_first_last_is_empty_impl::<ArrayStructBLen2>(25);
        assert_push_pop_get_len_first_last_is_empty_impl::<RawPtrNewtype>(26);
        assert_push_pop_get_len_first_last_is_empty_impl::<StructA>(27);
        assert_push_pop_get_len_first_last_is_empty_impl::<StructB>(28);
        assert_push_pop_get_len_first_last_is_empty_impl::<EnumSingleU8>(29);
        assert_push_pop_get_len_first_last_is_empty_impl::<EnumSingleU64>(30);
        assert_push_pop_get_len_first_last_is_empty_impl::<EnumSingleBool>(31);
        assert_push_pop_get_len_first_last_is_empty_impl::<EnumMultiUnits>(32);
        assert_push_pop_get_len_first_last_is_empty_impl::<EnumMultiOneByte>(33);
        assert_push_pop_get_len_first_last_is_empty_impl::<EnumU8AndU64>(34);
        assert_push_pop_get_len_first_last_is_empty_impl::<EnumQuadSlotSize>(35);
        assert_push_pop_get_len_first_last_is_empty_impl::<EnumLargerThanQuadSlot>(36);
        assert_push_pop_get_len_first_last_is_empty_impl::<(u8, u32)>(37);
    }
...
fn push_pop_get_len_first_last_is_empty() {
    let caller = abi(StorageVecPushPopGetLenFirstLastIsEmptyAbi, CONTRACT_ID);
