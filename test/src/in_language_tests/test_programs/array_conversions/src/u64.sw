...
fn u64_to_le_bytes() {
    ...
    assert_eq(result[2], 3_u8);
    assert_eq(result[3], 4_u8);
    assert_eq(result[4], 5_u8);
    assert_eq(result[5], 6_u8);
    assert_eq(result[6], 7_u8);
    assert_eq(result[7], 8_u8);
}
...
fn u64_to_be_bytes() {
    ...
    assert_eq(result[0], 8_u8);
    assert_eq(result[1], 7_u8);
    assert_eq(result[2], 6_u8);
    assert_eq(result[3], 5_u8);
    assert_eq(result[4], 4_u8);
    assert_eq(result[5], 3_u8);
    assert_eq(result[6], 2_u8);
    assert_eq(result[7], 1_u8);
}
