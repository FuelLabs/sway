...
fn contract_id_this() {
    ...
    let contract_abi = abi(ContractIdAbi, expected_contract_id.bits());

    let result_contract_id = contract_abi.this_contract_id();
    assert_eq(result_contract_id, expected_contract_id);
}

// Inline (non-contract) tests for the `ContractId` type.
...
fn contract_id_eq() {
    ...
    assert_eq(contract_id_3, contract_id_4);
    assert_eq(contract_id_5, contract_id_6);
}
...
fn contract_id_ne() {
    ...
    assert_ne(contract_id_1, contract_id_4);
    assert_ne(contract_id_1, contract_id_5);
    assert_ne(contract_id_1, contract_id_6);
    assert_ne(contract_id_2, contract_id_3);
    assert_ne(contract_id_2, contract_id_4);
    assert_ne(contract_id_2, contract_id_5);
    assert_ne(contract_id_2, contract_id_6);
    assert_ne(contract_id_3, contract_id_5);
    assert_ne(contract_id_3, contract_id_6);
    assert_ne(contract_id_4, contract_id_5);
    assert_ne(contract_id_4, contract_id_6);
}
...
fn contract_id_try_from_bytes() {
    ...
    assert_eq(contract_id_6.unwrap(), ContractId::zero());
    bytes_6.set(0, 255u8);
    assert_eq(contract_id_6.unwrap(), ContractId::zero());
}
