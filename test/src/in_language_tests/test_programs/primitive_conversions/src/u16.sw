...
fn u16_from_u8() {
    ...
    assert_eq(u16_1, 0u16);
    assert_eq(u16_2, 255u16);
    assert_eq(u16_3, 2u16);
}
...
fn u16_try_from_u32() {
    ...
    assert_eq(u16_1.unwrap(), 0u16);

    assert(u16_2.is_some());
    assert_eq(u16_2.unwrap(), u16::max());

    assert(u16_3.is_none());

    assert(u16_4.is_some());
    assert_eq(u16_4.unwrap(), 2u16);
}
...
fn u16_try_from_u64() {
    ...
    assert(u16_2.is_some());
    assert_eq(u16_2.unwrap(), 2u16);

    assert(u16_3.is_some());
    assert_eq(u16_3.unwrap(), u16::max());
