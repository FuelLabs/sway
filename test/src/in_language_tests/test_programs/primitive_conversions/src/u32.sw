...
fn u32_from_u8() {
    ...
    assert_eq(u32_1, 0u32);
    assert_eq(u32_2, 1u32);
    assert_eq(u32_3, 255u32);
}
...
fn u32_try_from_u64() {
    ...
    assert_eq(u32_1.unwrap(), 0u32);

    assert(u32_2.is_some());
    assert_eq(u32_2.unwrap(), 2u32);

    assert(u32_3.is_some());
    assert_eq(u32_3.unwrap(), u32::max());
