...
impl Contract {
    ...
    fn assert_reverse() {
        ...
        assert_reverse_impl::<str[6]>(11);
        assert_reverse_impl::<str[8]>(12);
        assert_reverse_impl::<str[12]>(13);
        assert_reverse_impl::<[u64; 2]>(14);
        assert_reverse_impl::<ArrayU8Len2>(15);
        assert_reverse_impl::<ArrayU64Len3>(16);
        assert_reverse_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_reverse_impl::<ArrayStructBLen2>(18);
        assert_reverse_impl::<RawPtrNewtype>(19);
        assert_reverse_impl::<StructA>(20);
        assert_reverse_impl::<StructB>(21);
        assert_reverse_impl::<EnumSingleU8>(22);
        assert_reverse_impl::<EnumSingleU64>(23);
        assert_reverse_impl::<EnumSingleBool>(24);
        assert_reverse_impl::<EnumMultiUnits>(25);
        assert_reverse_impl::<EnumMultiOneByte>(26);
        assert_reverse_impl::<EnumU8AndU64>(27);
        assert_reverse_impl::<EnumQuadSlotSize>(28);
        assert_reverse_impl::<EnumLargerThanQuadSlot>(29);
        assert_reverse_impl::<(u8, u32)>(30);
    }
