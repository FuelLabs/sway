...
pub fn wrapping_tests() {
    ...
    assert_eq(
        u256::from(0x0000000000000000000000000000000100000000000000000000000000000000)
            .wrapping_mul(u256::from(0x0000000000000000000000000000000100000000000000000000000000000000)),
        0,
    );
}
