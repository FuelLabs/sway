...
impl Contract {
    ...
    fn assert_push_and_get() {
        ...
        assert_push_and_get_impl::<str[6]>(11);
        assert_push_and_get_impl::<str[8]>(12);
        assert_push_and_get_impl::<str[12]>(13);
        assert_push_and_get_impl::<[u64; 2]>(14);
        assert_push_and_get_impl::<ArrayU8Len2>(15);
        assert_push_and_get_impl::<ArrayU64Len3>(16);
        assert_push_and_get_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_push_and_get_impl::<ArrayStructBLen2>(18);
        assert_push_and_get_impl::<RawPtrNewtype>(19);
        assert_push_and_get_impl::<StructA>(20);
        assert_push_and_get_impl::<StructB>(21);
        assert_push_and_get_impl::<EnumSingleU8>(22);
        assert_push_and_get_impl::<EnumSingleU64>(23);
        assert_push_and_get_impl::<EnumSingleBool>(24);
        assert_push_and_get_impl::<EnumMultiUnits>(25);
        assert_push_and_get_impl::<EnumMultiOneByte>(26);
        assert_push_and_get_impl::<EnumU8AndU64>(27);
        assert_push_and_get_impl::<EnumQuadSlotSize>(28);
        assert_push_and_get_impl::<EnumLargerThanQuadSlot>(29);
        assert_push_and_get_impl::<(u8, u32)>(30);
    }
}
