...
impl Contract {
    ...
    fn assert_swap_remove() {
        ...
        assert_swap_remove_impl::<str[6]>(11);
        assert_swap_remove_impl::<str[8]>(12);
        assert_swap_remove_impl::<str[12]>(13);
        assert_swap_remove_impl::<[u64; 2]>(14);
        assert_swap_remove_impl::<ArrayU8Len2>(15);
        assert_swap_remove_impl::<ArrayU64Len3>(16);
        assert_swap_remove_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_swap_remove_impl::<ArrayStructBLen2>(18);
        assert_swap_remove_impl::<RawPtrNewtype>(19);
        assert_swap_remove_impl::<StructA>(20);
        assert_swap_remove_impl::<StructB>(21);
        assert_swap_remove_impl::<EnumSingleU8>(22);
        assert_swap_remove_impl::<EnumSingleU64>(23);
        assert_swap_remove_impl::<EnumSingleBool>(24);
        assert_swap_remove_impl::<EnumMultiUnits>(25);
        assert_swap_remove_impl::<EnumMultiOneByte>(26);
        assert_swap_remove_impl::<EnumU8AndU64>(27);
        assert_swap_remove_impl::<EnumQuadSlotSize>(28);
        assert_swap_remove_impl::<EnumLargerThanQuadSlot>(29);
        assert_swap_remove_impl::<(u8, u32)>(30);
    }
