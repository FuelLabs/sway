...
fn evm_address_eq() {
    ...
    assert_eq(evm_address_1, evm_address_2);
    assert_eq(evm_address_3, evm_address_4);
    assert_eq(evm_address_5, evm_address_6);
}
...
fn evm_address_ne() {
    ...
    assert_ne(evm_address_1, evm_address_2);
    assert_ne(evm_address_1, evm_address_3);
    assert_ne(evm_address_2, evm_address_3);
}
...
fn evm_address_hash() {
    ...
    assert_eq(
        digest_2,
        0x78230345cedf8e92525c3cfdb8a95e947de1ed72e881b055dd80f9e523ff33e0,
    );
...
fn evm_address_try_from_bytes() {
    ...
    assert_eq(evm_address_3.unwrap(), EvmAddress::zero());
    ...
    assert_eq(evm_address_4.unwrap(), EvmAddress::from(b256::max()));
    ...
    assert_eq(evm_address_6.unwrap(), EvmAddress::zero());
    bytes_6.set(0, 255u8);
    assert_eq(evm_address_6.unwrap(), EvmAddress::zero());
}
...
fn evm_address_into_bytes() {
    ...
    assert_eq(bytes_1.capacity(), 20);
    assert_eq(bytes_1.len(), 20);
    let mut iter_1 = 0;
    while iter_1 < 20 {
    ...
    assert_eq(bytes_2.capacity(), 20);
    assert_eq(bytes_2.len(), 20);
    let mut iter_2 = 0;
    while iter_2 < 20 {
    ...
    assert_eq(bytes_3.capacity(), 20);
    assert_eq(bytes_3.len(), 20);
    assert_eq(bytes_3.get(19).unwrap(), 1u8);
    let mut iter_3 = 0;
    while iter_3 < 19 {
