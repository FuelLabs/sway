...
impl Contract {
    ...
    fn assert_empty_vec_next_returns_none() {
        ...
        assert_empty_vec_next_returns_none_impl::<str[6]>(11);
        assert_empty_vec_next_returns_none_impl::<str[8]>(12);
        assert_empty_vec_next_returns_none_impl::<str[12]>(13);
        assert_empty_vec_next_returns_none_impl::<[u64; 2]>(14);
        assert_empty_vec_next_returns_none_impl::<ArrayU8Len2>(15);
        assert_empty_vec_next_returns_none_impl::<ArrayU64Len3>(16);
        assert_empty_vec_next_returns_none_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_empty_vec_next_returns_none_impl::<ArrayStructBLen2>(18);
        assert_empty_vec_next_returns_none_impl::<RawPtrNewtype>(19);
        assert_empty_vec_next_returns_none_impl::<StructA>(20);
        assert_empty_vec_next_returns_none_impl::<StructB>(21);
        assert_empty_vec_next_returns_none_impl::<EnumSingleU8>(22);
        assert_empty_vec_next_returns_none_impl::<EnumSingleU64>(23);
        assert_empty_vec_next_returns_none_impl::<EnumSingleBool>(24);
        assert_empty_vec_next_returns_none_impl::<EnumMultiUnits>(25);
        assert_empty_vec_next_returns_none_impl::<EnumMultiOneByte>(26);
        assert_empty_vec_next_returns_none_impl::<EnumU8AndU64>(27);
        assert_empty_vec_next_returns_none_impl::<EnumQuadSlotSize>(28);
        assert_empty_vec_next_returns_none_impl::<EnumLargerThanQuadSlot>(29);
        assert_empty_vec_next_returns_none_impl::<(u8, u32)>(30);
    }
    ...
    fn assert_vec_with_elements_next_returns_element() {
        ...
        assert_vec_with_elements_next_returns_element_impl::<str[6]>(11);
        assert_vec_with_elements_next_returns_element_impl::<str[8]>(12);
        assert_vec_with_elements_next_returns_element_impl::<str[12]>(13);
        assert_vec_with_elements_next_returns_element_impl::<[u64; 2]>(14);
        assert_vec_with_elements_next_returns_element_impl::<ArrayU8Len2>(15);
        assert_vec_with_elements_next_returns_element_impl::<ArrayU64Len3>(16);
        assert_vec_with_elements_next_returns_element_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_vec_with_elements_next_returns_element_impl::<ArrayStructBLen2>(18);
        assert_vec_with_elements_next_returns_element_impl::<RawPtrNewtype>(19);
        assert_vec_with_elements_next_returns_element_impl::<StructA>(20);
        assert_vec_with_elements_next_returns_element_impl::<StructB>(21);
        assert_vec_with_elements_next_returns_element_impl::<EnumSingleU8>(22);
        assert_vec_with_elements_next_returns_element_impl::<EnumSingleU64>(23);
        assert_vec_with_elements_next_returns_element_impl::<EnumSingleBool>(24);
        assert_vec_with_elements_next_returns_element_impl::<EnumMultiUnits>(25);
        assert_vec_with_elements_next_returns_element_impl::<EnumMultiOneByte>(26);
        assert_vec_with_elements_next_returns_element_impl::<EnumU8AndU64>(27);
        assert_vec_with_elements_next_returns_element_impl::<EnumQuadSlotSize>(28);
        assert_vec_with_elements_next_returns_element_impl::<EnumLargerThanQuadSlot>(29);
        assert_vec_with_elements_next_returns_element_impl::<(u8, u32)>(30);
    }
    ...
    fn assert_vec_with_elements_for_loop_iteration() {
        ...
        assert_vec_with_elements_for_loop_iteration_impl::<str[6]>(11);
        assert_vec_with_elements_for_loop_iteration_impl::<str[8]>(12);
        assert_vec_with_elements_for_loop_iteration_impl::<str[12]>(13);
        assert_vec_with_elements_for_loop_iteration_impl::<[u64; 2]>(14);
        assert_vec_with_elements_for_loop_iteration_impl::<ArrayU8Len2>(15);
        assert_vec_with_elements_for_loop_iteration_impl::<ArrayU64Len3>(16);
        assert_vec_with_elements_for_loop_iteration_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_vec_with_elements_for_loop_iteration_impl::<ArrayStructBLen2>(18);
        assert_vec_with_elements_for_loop_iteration_impl::<RawPtrNewtype>(19);
        assert_vec_with_elements_for_loop_iteration_impl::<StructA>(20);
        assert_vec_with_elements_for_loop_iteration_impl::<StructB>(21);
        assert_vec_with_elements_for_loop_iteration_impl::<EnumSingleU8>(22);
        assert_vec_with_elements_for_loop_iteration_impl::<EnumSingleU64>(23);
        assert_vec_with_elements_for_loop_iteration_impl::<EnumSingleBool>(24);
        assert_vec_with_elements_for_loop_iteration_impl::<EnumMultiUnits>(25);
        assert_vec_with_elements_for_loop_iteration_impl::<EnumMultiOneByte>(26);
        assert_vec_with_elements_for_loop_iteration_impl::<EnumU8AndU64>(27);
        assert_vec_with_elements_for_loop_iteration_impl::<EnumQuadSlotSize>(28);
        assert_vec_with_elements_for_loop_iteration_impl::<EnumLargerThanQuadSlot>(29);
        assert_vec_with_elements_for_loop_iteration_impl::<(u8, u32)>(30);
    }
