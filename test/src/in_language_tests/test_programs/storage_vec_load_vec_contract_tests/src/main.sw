...
impl Contract {
    ...
    fn assert_load_vec() {
        ...
        assert_load_vec_impl::<str[6]>(11);
        assert_load_vec_impl::<str[8]>(12);
        assert_load_vec_impl::<str[12]>(13);
        assert_load_vec_impl::<[u64; 2]>(14);
        assert_load_vec_impl::<ArrayU8Len2>(15);
        assert_load_vec_impl::<ArrayU64Len3>(16);
        assert_load_vec_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_load_vec_impl::<ArrayStructBLen2>(18);
        assert_load_vec_impl::<RawPtrNewtype>(19);
        assert_load_vec_impl::<StructA>(20);
        assert_load_vec_impl::<StructB>(21);
        assert_load_vec_impl::<EnumSingleU8>(22);
        assert_load_vec_impl::<EnumSingleU64>(23);
        assert_load_vec_impl::<EnumSingleBool>(24);
        assert_load_vec_impl::<EnumMultiUnits>(25);
        assert_load_vec_impl::<EnumMultiOneByte>(26);
        assert_load_vec_impl::<EnumU8AndU64>(27);
        assert_load_vec_impl::<EnumQuadSlotSize>(28);
        assert_load_vec_impl::<EnumLargerThanQuadSlot>(29);
        assert_load_vec_impl::<(u8, u32)>(30);
    }
