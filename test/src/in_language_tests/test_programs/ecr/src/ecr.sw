...
fn ecr_ec_recover() {
    ...
    assert_eq(result_1.unwrap().bits()[0], pub_hi);
    assert_eq(result_1.unwrap().bits()[1], pub_lo);
...
fn ecr_ec_recover_r1() {
    ...
    assert(result_1.is_ok());
    assert_eq(result_1.unwrap().bits()[0], pub_hi_1);
    assert_eq(result_1.unwrap().bits()[1], pub_lo_1);
...
fn ecr_ec_recover_address() {
    ...
    assert(result_1.is_ok());
    assert_eq(result_1.unwrap(), address_1);
