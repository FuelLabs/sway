...
fn secp256r1_new() {
    ...
    let mut iter = 0;
    while iter < 64 {
        assert_eq(new_secp256r1.bits()[iter], 0u8);
        iter += 1;
    }
}
...
fn secp256r1_recover() {
    ...
    assert_eq(public_key, result_public_key.unwrap());
...
fn secp256r1_address() {
    ...
    assert_eq(result_address.unwrap(), address);
...
fn secp256r1_evm_address() {
    ...
    assert_eq(result_1.unwrap(), expected_evm_address);
...
fn secp256r1_from_b512() {
    ...
    let mut iter_1 = 0;
    while iter_1 < 64 {
        assert_eq(secp256r1_1.bits()[iter_1], 0u8);
        iter_1 += 1;
    }
    ...
    assert_eq(secp256r1_2.bits()[63], 1u8);
    let mut iter_2 = 0;
    while iter_2 < 63 {
        assert_eq(secp256r1_2.bits()[iter_2], 0u8);
        iter_2 += 1;
    }
    ...
    let mut iter_3 = 0;
    while iter_3 < 64 {
        assert_eq(secp256r1_3.bits()[iter_3], 255u8);
        iter_3 += 1;
    }
}
...
fn secp256r1_into_b512() {
    let b512_1 = B512::from((b256::zero(), b256::zero()));
    let secp256r1_1 = Secp256r1::from(b512_1);
    assert_eq(<Secp256r1 as Into<B512>>::into(secp256r1_1), b512_1);
    ...
    let secp256r1_2 = Secp256r1::from(b512_2);
    assert_eq(<Secp256r1 as Into<B512>>::into(secp256r1_2), b512_2);

    let b512_3 = B512::from((b256::max(), b256::max()));
    let secp256r1_3 = Secp256r1::from(b512_3);
    assert_eq(<Secp256r1 as Into<B512>>::into(secp256r1_3), b512_3);
}
...
fn secp256r1_into_bytes() {
    ...
    let mut iter_1 = 0;
    while iter_1 < 64 {
        assert_eq(bytes_result_1.get(iter_1).unwrap(), 0u8);
        iter_1 += 1;
    }
    ...
    assert_eq(bytes_result_2.get(63).unwrap(), 1u8);
    let mut iter_2 = 0;
    while iter_2 < 63 {
        assert_eq(bytes_result_2.get(iter_2).unwrap(), 0u8);
        iter_2 += 1;
    }
    ...
    let mut iter_3 = 0;
    while iter_3 < 64 {
        assert_eq(bytes_result_3.get(iter_3).unwrap(), 255u8);
        iter_3 += 1;
    }
}
