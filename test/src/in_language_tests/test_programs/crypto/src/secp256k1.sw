...
fn secp256k1_new() {
    ...
    let mut iter = 0;
    while iter < 64 {
        assert_eq(new_secp256k1.bits()[iter], 0u8);
        iter += 1;
    }
}
...
fn secp256k1_from_b512() {
    ...
    let mut iter_1 = 0;
    while iter_1 < 64 {
        assert_eq(secp256k1_1.bits()[iter_1], 0u8);
        iter_1 += 1;
    }
    ...
    assert_eq(secp256k1_2.bits()[63], 1u8);
    let mut iter_2 = 0;
    while iter_2 < 63 {
        assert_eq(secp256k1_2.bits()[iter_2], 0u8);
        iter_2 += 1;
    }
    ...
    let mut iter_3 = 0;
    while iter_3 < 64 {
        assert_eq(secp256k1_3.bits()[iter_3], 255u8);
        iter_3 += 1;
    }
}
...
fn secp256k1_into_b512() {
    let b512_1 = B512::from((b256::zero(), b256::zero()));
    let secp256k1_1 = Secp256k1::from(b512_1);
    assert_eq(<Secp256k1 as Into<B512>>::into(secp256k1_1), b512_1);
    ...
    let secp256k1_2 = Secp256k1::from(b512_2);
    assert_eq(<Secp256k1 as Into<B512>>::into(secp256k1_2), b512_2);

    let b512_3 = B512::from((b256::max(), b256::max()));
    let secp256k1_3 = Secp256k1::from(b512_3);
    assert_eq(<Secp256k1 as Into<B512>>::into(secp256k1_3), b512_3);
}
