...
fn zk_alt_bn128_add() {
    ...
    assert_eq(result_1, expected_point_1);
    ...
    assert_eq(result_2, expected_point_2);
    ...
    assert_eq(result_3, expected_point_3);
    ...
    assert_eq(result_4, expected_point_4);
    ...
    assert_eq(result_5, expected_point_5);
}
