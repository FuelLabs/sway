...
fn signature_recover() {
    ...
    assert_eq(public_key_1, result_public_key_1.unwrap());
    ...
    assert_eq(public_key_2, result_public_key_2.unwrap());
...
fn signature_bits() {
    ...
    let mut iter = 0;
    while iter < 64 {
        assert_eq(secp256r1_bits[iter], 0u8);
        iter += 1;
    }
    ...
    let mut iter = 0;
    while iter < 64 {
        assert_eq(secp256k1_bits[iter], 0u8);
        iter += 1;
    }
    ...
    let mut iter = 0;
    while iter < 64 {
        assert_eq(ed25519_bits[iter], 0u8);
        iter += 1;
    }
}
...
fn signature_eq() {
    ...
    assert_eq(secp256r1_1, secp256r1_2);
    assert_eq(secp256r1_3, secp256r1_4);
    assert_eq(secp256r1_5, secp256r1_6);
    assert_ne(secp256r1_1, secp256r1_3);
    assert_ne(secp256r1_1, secp256r1_5);
    assert_ne(secp256r1_3, secp256r1_5);

    assert_eq(secp256k1_1, secp256k1_2);
    assert_eq(secp256k1_3, secp256k1_4);
    assert_eq(secp256k1_5, secp256k1_6);
    assert_ne(secp256k1_1, secp256k1_3);
    assert_ne(secp256k1_1, secp256k1_5);
    assert_ne(secp256k1_3, secp256k1_5);

    assert_eq(ed25519_1, ed25519_2);
    assert_eq(ed25519_3, ed25519_4);
    assert_eq(ed25519_5, ed25519_6);
    assert_ne(ed25519_1, ed25519_3);
    assert_ne(ed25519_1, ed25519_5);
    assert_ne(ed25519_3, ed25519_5);

    assert_ne(secp256r1_1, secp256k1_1);
    assert_ne(secp256r1_1, ed25519_1);
    assert_ne(secp256r1_3, secp256k1_3);
    assert_ne(secp256r1_3, ed25519_3);
    assert_ne(secp256r1_5, secp256k1_5);
    assert_ne(secp256r1_5, ed25519_5);

    assert_ne(secp256r1_1, ed25519_3);
    assert_ne(secp256r1_1, secp256k1_3);
    assert_ne(secp256r1_1, ed25519_5);
    assert_ne(secp256r1_1, secp256k1_5);

    assert_ne(secp256k1_1, ed25519_1);
    assert_ne(secp256k1_3, ed25519_3);
    assert_ne(secp256k1_5, ed25519_5);

    assert_ne(secp256k1_1, ed25519_3);
    assert_ne(secp256k1_1, ed25519_5);
}
