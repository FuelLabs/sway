...
impl Contract {
    ...
    fn assert_set() {
        ...
        assert_set_impl::<str[6]>(11);
        assert_set_impl::<str[8]>(12);
        assert_set_impl::<str[12]>(13);
        assert_set_impl::<[u64; 2]>(14);
        assert_set_impl::<ArrayU8Len2>(15);
        assert_set_impl::<ArrayU64Len3>(16);
        assert_set_impl::<ArrayNestedArrayU8Len2Len3>(17);
        assert_set_impl::<ArrayStructBLen2>(18);
        assert_set_impl::<RawPtrNewtype>(19);
        assert_set_impl::<StructA>(20);
        assert_set_impl::<StructB>(21);
        assert_set_impl::<EnumSingleU8>(22);
        assert_set_impl::<EnumSingleU64>(23);
        assert_set_impl::<EnumSingleBool>(24);
        assert_set_impl::<EnumMultiUnits>(25);
        assert_set_impl::<EnumMultiOneByte>(26);
        assert_set_impl::<EnumU8AndU64>(27);
        assert_set_impl::<EnumQuadSlotSize>(28);
        assert_set_impl::<EnumLargerThanQuadSlot>(29);
        assert_set_impl::<(u8, u32)>(30);
    }
