...
// Disabled
// This test is supposed to test that `use` without `pub` makes the item private,
// but the path resolution is broken, so the test doesn't test what it's supposed to test.
