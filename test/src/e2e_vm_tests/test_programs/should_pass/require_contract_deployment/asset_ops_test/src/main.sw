...
const FUEL_COIN_CONTRACT_ID = [1;32mFinished[0m; // AUTO-CONTRACT-ID ../../test_contracts/test_fuel_coin_contract --release

#[cfg(experimental_new_encoding = false)]
const BALANCE_CONTRACT_ID = 0xf6cd545152ac83225e8e7df2efb5c6fa6e37bc9b9e977b5ea8103d28668925df;
#[cfg(experimental_new_encoding = true)]
const BALANCE_CONTRACT_ID = fuel]; // AUTO-CONTRACT-ID ../../test_contracts/balance_test_contract --release
