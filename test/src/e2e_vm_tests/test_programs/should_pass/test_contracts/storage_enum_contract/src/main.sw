...
impl StorageEnum for Contract {
    ...
    fn read_write_enums() -> u64 {
        ...
        storage
            .slot_s_b
            .write(SlotSize::B((123456, 1234567, 12345678)));
        let _ = check_slot_s(123, (123456, 1234567, 12345678));
        storage
            .slot_s_a
            .write(SlotSize::B((612345, 7123456, 81234567)));
        ...
        storage
            .slot_s_b
            .write(SlotSize::B((0xAA00, 0xBB00, 0xCC00)));
        let _ = check_slot_s(0xEE, (0xAA00, 0xBB00, 0xCC00));
        ...
        storage
            .lt_slot_b
            .write(LargerThanSlot::B((123456, 1234567, 12345678, 123456789, 1234567890)));
        let _ = check_lt_slot(123, (123456, 1234567, 12345678, 123456789, 1234567890));
        storage
            .lt_slot_a
            .write(LargerThanSlot::B((612345, 723456, 8234567, 912345678, 123456789)));
        ...
        storage
            .lt_slot_b
            .write(LargerThanSlot::B((0xAB00, 0xBC00, 0xCD00, 0xDE00, 0xEF00)));
        let _ = check_lt_slot(0xFF, (0xAB00, 0xBC00, 0xCD00, 0xDE00, 0xEF00));
...
fn check_lt_slot(expected_u8: u8, expected_tuple: (u64, u64, u64, u64, u64)) -> u64 {
    ...
    match (a, b) {
        (LargerThanSlot::A(a), LargerThanSlot::B(b)) => {
            assert(a == expected_u8);
            assert(
                b.0 == expected_tuple.0
                && b.1 == expected_tuple.1
                && b.2 == expected_tuple.2
                && b.3 == expected_tuple.3
                && b.4 == expected_tuple.4,
            );
            return 171;
        },
