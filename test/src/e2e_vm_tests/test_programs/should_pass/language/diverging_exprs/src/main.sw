...
#[inline(never)]
fn diverge_in_if_with_revert(cond: bool) -> (u64, u64) {
...
#[inline(never)]
fn diverge_in_match_with_revert(cond: bool) -> (u64, u64) {
...
fn main() -> u64 {
    ...
    let result = diverge_in_if_with_revert(false);
    assert(result.0 == 5);
    assert(result.1 == 5);

    let result = diverge_in_match_with_revert(false);
    assert(result.0 == 5);
    assert(result.1 == 5);
