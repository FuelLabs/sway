...
fn pass_references_to_asm_blocks() {
    ...
    let r_x_ptr_1 = asm(r: &x) {
        r: raw_ptr
    };
    let r_x_ptr_2 = asm(r: r_x) {
        r: raw_ptr
    };

    assert(r_x_ptr_1 == r_x_ptr_2);

    let r_mut_x_ptr_1 = asm(r: &mut x) {
        r: raw_ptr
    };
    let r_mut_x_ptr_2 = asm(r: r_mut_x) {
        r: raw_ptr
    };
    ...
    let r_val_ptr_1 = asm(r: &123u8) {
        r: raw_ptr
    };
    let r_val_ptr_2 = asm(r: &(100u8 + 23u8)) {
        r: raw_ptr
    };
    let r_val_ptr_3 = asm(r: &return_123u8()) {
        r: raw_ptr
    };
    ...
    let r_val_ptr_1 = asm(r: &mut 123u8) {
        r: raw_ptr
    };
    let r_val_ptr_2 = asm(r: &mut (100u8 + 23u8)) {
        r: raw_ptr
    };
    let r_val_ptr_3 = asm(r: &mut return_123u8()) {
        r: raw_ptr
    };
...
fn return_references_from_asm_blocks() {
    ...
    let r_x_ref_1 = asm(r: &x) {
        r: &u8
    };
    let r_x_ref_2 = asm(r: r_x) {
        r: &u8
    };

    let r_x_ref_1_ptr = asm(r: r_x_ref_1) {
        r: raw_ptr
    };
    let r_x_ref_2_ptr = asm(r: r_x_ref_2) {
        r: raw_ptr
    };
    ...
    let r_x_ref_1: &mut u8 = asm(r: &x) {
        r: &mut u8
    };
    let r_x_ref_2: &mut u8 = asm(r: r_x) {
        r: &mut u8
    };
    ...
    let r_s_ref_1 = asm(r: &s) {
        r: &S
    };
    let r_s_ref_2 = asm(r: r_s) {
        r: &S
    };

    let r_s_ref_1_ptr = asm(r: r_s_ref_1) {
        r: raw_ptr
    };
    let r_s_ref_2_ptr = asm(r: r_s_ref_2) {
        r: raw_ptr
    };
