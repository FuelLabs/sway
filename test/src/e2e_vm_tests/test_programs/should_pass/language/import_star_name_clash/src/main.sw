...
fn good_project_my_enum_a(e: a::MyEnum) -> u64 {
    match e {
        ...
        a::MyEnum::A(val) | a::MyEnum::B(val) => val,
    }
}
...
fn good_project_my_enum_variants(e: MyEnumVariants) -> u64 {
    match e {
        ...
        MyEnumVariants::D(val) | MyEnumVariants::E(val) => val,
    }
}
...
fn good_project_my_other_enum_variants(e: MyOtherEnumVariants) -> u64 {
    match e {
        ...
        MyOtherEnumVariants::E(val) | MyOtherEnumVariants::F(val) => val,
    }
}
...
fn main() -> u64 {
    ...
    my_struct_a_relative.a + my_struct_a_absolute.a + my_struct_b_relative.b + my_struct_b_absolute.b + good_project_my_enum_a(my_enum_a_enum_variant_relative) + good_project_my_enum_a(my_enum_a_enum_variant_absolute) + good_project_my_enum_b(my_enum_b_enum_variant_relative) + good_project_my_enum_b(my_enum_b_enum_variant_absolute) + my_enum_function_type + my_enum_local_function_3 + c_struct_relative.b + c_struct_absolute.b + good_project_my_other_enum_b(c_variant_enum) + good_project_my_other_enum_b(c_variant_enum_relative) + good_project_my_other_enum_b(c_variant_enum_absolute) + good_project_my_enum_variants(variants_d) + good_project_my_enum_variants(variants_d_enum_variant) + good_project_my_enum_variants(variants_d_relative) + good_project_my_enum_variants(variants_d_absolute) + good_project_my_enum_variants(variants_e_enum_variant) + good_project_my_enum_variants(variants_e_relative) + good_project_my_enum_variants(variants_e_absolute) + good_project_my_other_enum_variants(variants_other_e_enum_variant) + good_project_my_other_enum_variants(variants_other_e_relative) + good_project_my_other_enum_variants(variants_other_e_absolute) + good_project_my_other_enum_variants(variants_f) + good_project_my_other_enum_variants(variants_f_enum_variant) + good_project_my_other_enum_variants(variants_f_relative) + good_project_my_other_enum_variants(variants_f_absolute) + variants_function_2
}
