...
fn report_assembly_information(
    ...
    // Merge the data section entry slots together for usage calculation.
    let mut data_section_entries: Vec<_> = compiled_asm.0.data_section.non_configurables.clone();
    data_section_entries.extend(compiled_asm.0.data_section.configurables.clone());
