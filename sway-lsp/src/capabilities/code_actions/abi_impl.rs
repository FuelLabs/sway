...
use sway_core::{
    language::ty::{TyAbiDeclaration, TyFunctionParameter, TyTraitDeclarationItem, TyTraitFn},
    Engines,
};
...
fn get_function_signatures(engines: Engines<'_>, abi_decl: TyAbiDeclaration) -> String {
    ...
    abi_decl
        ...
        .filter_map(|item| match item {
            TyTraitDeclarationItem::TraitFn(function_decl_id) => decl_engine
            ...
            TyTraitDeclarationItem::Constant(_) => todo!(),
        })
        .collect::<Vec<String>>()
        .join("\n")
}
