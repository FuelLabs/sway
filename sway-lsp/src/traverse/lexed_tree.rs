...
impl Parse for ItemTrait {
    fn parse(&self, ctx: &ParseContext) {
        ...
        self.trait_items
            .get()
            .iter()
            .for_each(|item| item.0.value.parse(ctx));
