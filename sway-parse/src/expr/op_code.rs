...
define_op_codes!(
    ...
    (Sclr, SclrOpcode, "sclr", (addr, len)),
    (Srw, SrwOpcode, "srw", (ret, is_set, state_addr, offset)),
    (Srwq, SrwqOpcode, "srwq", (addr, is_set, state_addr, count)),
    (Srdd, SrddOpcode, "srdd", (addr, state_addr, offset, len)),
    (Srdi, SrdiOpcode, "srdi", (addr, state_addr, offset, len)),
    (Sww, SwwOpcode, "sww", (state_addr, is_set, value)),
    (Swwq, SwwqOpcode, "swwq", (state_addr, is_set, addr, count)),
    (Swrd, SwrdOpcode, "swrd", (state_addr, addr, len)),
    (Swri, SwriOpcode, "swri", (state_addr, addr, len)),
    (Supd, SupdOpcode, "supd", (state_addr, addr, offset, len)),
    (Supi, SupiOpcode, "supi", (state_addr, addr, offset, len)),
    (Spld, SpldOpcode, "spld", (dest_len, state_addr)),
