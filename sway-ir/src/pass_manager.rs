use crate::{
    ...
    create_fn_dedup_debug_profile_pass, create_fn_dedup_demonomorphize_pass,
    ...
    ARG_DEMOTION_NAME, CCP_NAME, CONST_DEMOTION_NAME, CONST_FOLDING_NAME, CSE_NAME, DCE_NAME,
