...
/// Default max width in the body of a structure literal before falling back to vertical formatting.
pub const DEFAULT_STRUCT_LIT_WIDTH: usize = 18;
/// Default max width in the body of a structure variant before falling back to vertical formatting.
