...
generate_tuple_encode() {
    ...
    CODE="$CODE{ fn is_encode_trivial() -> bool { let r = __mem_repr_eq::<Self>(\"runtime\", \"encoding\"); $ISTRIVIAL r } fn abi_encode(self, buffer: Buffer) -> Buffer { "
...
generate_tuple_decode() {
    ...
    CODE="$CODE{ fn is_decode_trivial() -> bool { let r = __mem_repr_eq::<Self>(\"runtime\", \"encoding\"); $ISTRIVIAL r } fn abi_decode(ref mut buffer: BufferReader) -> Self { ("
