...
pub const TX_TYPE_OFFSET = 10240;
pub const TX_GAS_PRICE_OFFSET = 10248;
pub const TX_GAS_LIMIT_OFFSET = 10256;
pub const TX_BYTE_PRICE_OFFSET = 10264;
pub const TX_MATURITY_OFFSET = 10272;
pub const TX_SCRIPT_LENGTH_OFFSET = 10280;
pub const TX_SCRIPT_DATA_LENGTH_OFFSET = 10288;
pub const TX_INPUTS_COUNT_OFFSET = 10296;
pub const TX_OUTPUTS_COUNT_OFFSET = 10304;
pub const TX_WITNESSES_COUNT_OFFSET = 10312;
pub const TX_RECEIPTS_ROOT_OFFSET = 10320;
pub const TX_SCRIPT_START_OFFSET = 10352;
pub const TX_ID_OFFSET = 0;
