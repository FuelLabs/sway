...
/**
GTF Immediate Hex values:

const GTF_SCRIPT_WITNESS_AT_INDEX = 0x00F

 GTF_CREATE_GAS_PRICE = 0x010
 GTF_CREATE_GAS_LIMIT = 0x011
 GTF_CREATE_MATURITY = 0x012
 GTF_CREATE_BYTECODE_LENGTH = 0x013
 GTF_CREATE_BYTECODE_WITNESS_INDEX = 0x014
 GTF_CREATE_STORAGE_SLOTS_COUNT = 0x015
 GTF_CREATE_INPUTS_COUNT = 0x016
 GTF_CREATE_OUTPUTS_COUNT = 0x017
 GTF_CREATE_WITNESSES_COUNT = 0x018
 GTF_CREATE_SALT = 0x019
 GTF_CREATE_STORAGE_SLOT_AT_INDEX = 0x01A
 GTF_CREATE_INPUT_AT_INDEX = 0x01B
 GTF_CREATE_OUTPUT_AT_INDEX = 0x01C
 GTF_CREATE_WITNESS_AT_INDEX = 0x01D

 GTF_INPUT_COIN_OUTPUT_INDEX = 0x103
 GTF_INPUT_COIN_AMOUNT = 0x105
 GTF_INPUT_COIN_ASSET_ID = 0x106
 GTF_INPUT_COIN_TX_POINTER = 0x107
 GTF_INPUT_COIN_WITNESS_INDEX = 0x108
 GTF_INPUT_COIN_MATURITY = 0x109
 GTF_INPUT_COIN_PREDICATE_LENGTH = 0x10A
 GTF_INPUT_COIN_PREDICATE_DATA_LENGTH = 0x10B
 GTF_INPUT_COIN_PREDICATE = 0x10C

 GTF_INPUT_CONTRACT_OUTPUT_INDEX = 0x10F
 GTF_INPUT_CONTRACT_BALANCE_ROOT = 0x110
 GTF_INPUT_CONTRACT_STATE_ROOT = 0x111
 GTF_INPUT_CONTRACT_TX_POINTER = 0x112
 GTF_INPUT_CONTRACT_CONTRACT_ID = 0x113

 GTF_INPUT_MESSAGE_MESSAGE_ID = 0x114
 GTF_INPUT_MESSAGE_SENDER = 0x115
 GTF_INPUT_MESSAGE_RECIPIENT = 0x116
 GTF_INPUT_MESSAGE_AMOUNT = 0x117
 GTF_INPUT_MESSAGE_NONCE = 0x118
 GTF_INPUT_MESSAGE_WITNESS_INDEX = 0x11A
 GTF_INPUT_MESSAGE_DATA_LENGTH = 0x11B
 GTF_INPUT_MESSAGE_PREDICATE_LENGTH = 0x11C
 GTF_INPUT_MESSAGE_PREDICATE_DATA_LENGTH = 0x11D
 GTF_INPUT_MESSAGE_DATA = 0x11E
 GTF_INPUT_MESSAGE_PREDICATE = 0x11F

 GTF_OUTPUT_COIN_TO = 0x202
 GTF_OUTPUT_COIN_ASSET_ID = 0x204

 GTF_OUTPUT_CONTRACT_INPUT_INDEX = 0x205
 GTF_OUTPUT_CONTRACT_BALANCE_ROOT = 0x206
 GTF_OUTPUT_CONTRACT_STATE_ROOT = 0x207

 GTF_OUTPUT_MESSAGE_RECIPIENT = 0x208

 GTF_OUTPUT_CONTRACT_CREATED_CONTRACT_ID = 0x20A
 GTF_OUTPUT_CONTRACT_CREATED_STATE_ROOT = 0x20B

 GTF_WITNESS_DATA_LENGTH = 0x301
