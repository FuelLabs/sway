...
fn test_hasher_sha256_str_array() {
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0x4a3cd7c8b44dbf7941e55179425f746adeaa97fe2d99b571fffee78e9b41743c,
    );
}
...
fn test_hasher_sha256_u8() {
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0x6e340b9cffb37a989ca544e6bb780a2c78901d3fb33738768511a30617afa01d,
    );
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0x4bf5122f344554c53bde2ebb8cd2b7e3d1600ad631c385a5d7cce23c7785459a,
    );
}
...
fn test_hasher_sha256_u16() {
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0x96a296d224f285c67bee93c30f8a309157f0daa35dc5b87e410b78630a09cfc7,
    );
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0xb413f47d13ee2fe6c845b2ee141af81de858df4ec549a58b7970bb96645bc8d2,
    );
}
...
fn test_hasher_sha256_u32() {
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0xdf3f619804a92fdb4057192dc43dd748ea778adc52bc498ce80524c014b81119,
    );
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0xb40711a88c7039756fb8a73827eabe2c0fe5a0346ca7e0a104adc0fc764f528d,
    );
}
...
fn test_hasher_sha256_u64() {
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0xaf5570f5a1810b7af78caf4bc70a660f0df51e42baf91d4de5b2328de0e83dfc,
    );
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0xcd2662154e6d76b2b2b92e70c0cac3ccf534f9b74eb5b89819ec509083d00a50,
    );
}
...
fn test_hasher_sha256_b256() {
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0x66687aadf862bd776c8fc18b8e9f8e20089714856ee233b3902a591d0d5f2925,
    );
    ...
    let sha256 = hasher.sha256();
    assert(
        sha256 == 0xec4916dd28fc4c10d78e287ca5d9cc51ee1ae73cbfde08c6b37324cbfaac8bc5,
    );
}
...
fn test_hasher_keccak256_str_array() {
    ...
    assert(
        keccak256 == 0x9c22ff5f21f0b81b113e63f7db6da94fedef11b2119b4088b89664fb9a3cb658,
    );
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0xab8e83e041e001bcf797c9cc7d6bc472bfdb8c736bab7999f13b7c26f48c354f,
    );
}
...
fn test_hasher_keccak256_u8() {
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0xbc36789e7a1e281436464229828f817d6612f7b477d66591ff96a9e064bcc98a,
    );
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0x5fe7f977e71dba2ea1a68e21057beebb9be2ac30c6410aa38d4f3fbe41dcffd2,
    );
}
...
fn test_hasher_keccak256_u16() {
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0x54a8c0ab653c15bfb48b47fd011ba2b9617af01cb45cab344acd57c924d56798,
    );
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0x49d03a195e239b52779866b33024210fc7dc66e9c2998975c0aa45c1702549d5,
    );
}
...
fn test_hasher_keccak256_u32() {
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0xe8e77626586f73b955364c7b4bbf0bb7f7685ebd40e852b164633a4acbd3244c,
    );
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0x51f81bcdfc324a0dff2b5bec9d92e21cbebc4d5e29d3a3d30de3e03fbeab8d7f,
    );
}
...
fn test_hasher_keccak256_u64() {
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0x011b4d03dd8c01f1049143cf9c4c817e4b167f1d1b83e5c6f0f10d89ba1e7bce,
    );
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0x6c31fc15422ebad28aaf9089c306702f67540b53c7eea8b7d2941044b027100f,
    );
}
...
fn test_hasher_keccak256_b256() {
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e563,
    );
    ...
    let keccak256 = hasher.keccak256();
    assert(
        keccak256 == 0xb10e2d527612073b26eecdfd717e6a320cf44b4afac2b0732d9fcbe2b7fa0cf6,
    );
}
