...
var hljs = function () {
  "use strict"; var e = { exports: {} }; function t(e) {
    return e instanceof Map ? e.clear = e.delete = e.set = () => {
      ...
      var s = e[n]
        ; "object" != typeof s || Object.isFrozen(s) || t(s)
    })), e
  }
  e.exports = t, e.exports.default = t; var n = e.exports; class s {
    constructor(e) {
  ...
  function b(...e) { return e.map((e => d(e))).join("") } function p(...e) {
    const t = (e => {
  ...
  const m = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./
    ; function E(e, { joinWith: t }) {
      let n = 0; return e.map((e => {
        n += 1; const t = n
          ; let s = d(e), i = ""; for (; s.length > 0;) {
            const e = m.exec(s); if (!e) { i += s; break }
  ...
  const _ = "[a-zA-Z]\\w*", w = "[a-zA-Z_]\\w*", y = "\\b\\d+(\\.\\d+)?", N = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", x = "\\b(0b[01]+)", k = {
    ...
    SHEBANG: (e = {}) => {
      const t = /^#![ ]*\//
        ; return e.binary && (e.begin = b(t, /.*\b/, e.binary, /\b.*/)), a({
          scope: "meta", begin: t,
    ...
    ; function U(e, t, n = "keyword") {
      ...
      return t ? Number(t) : (e => $.includes(e.toLowerCase()))(e) ? 0 : 1
    } const P = {}, K = e => {
      console.error(e)
    }, G = (e, ...t) => { console.log("WARN: " + e, ...t) }, F = (e, t) => {
      P[`${e}/${t}`] || (console.log(`Deprecated as of ${e}. ${t}`), P[`${e}/${t}`] = !0)
    }, Z = Error(); function W(e, t, { key: n }) {
      let s = 0; const i = e[n], a = {}, r = {}
        ; for (let e = 1; e <= t.length; e++)r[e + s] = i[e], a[e + s] = !0, s += f(t[e - 1])
          ; e[n] = r, e[n]._emit = a, e[n]._multi = !0
    } function X(e) {
      (e => {
        ...
        if (Array.isArray(e.begin)) {
          if (e.skip || e.excludeBegin || e.returnBegin) throw K("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),
            ...
            ; if ("object" != typeof e.beginScope || null === e.beginScope) throw K("beginScope must be object"),
              Z; W(e, e.begin, { key: "beginScope" }), e.begin = E(e.begin, { joinWith: "" })
        }
      })(e), (e => {
        if (Array.isArray(e.end)) {
          if (e.skip || e.excludeEnd || e.returnEnd) throw K("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
            ...
            ; if ("object" != typeof e.endScope || null === e.endScope) throw K("endScope must be object"),
              Z; W(e, e.end, { key: "endScope" }), e.end = E(e.end, { joinWith: "" })
        }
      })(e)
    } function q(e) {
      function t(t, n) {
      ...
      if (e.compilerExtensions || (e.compilerExtensions = []),
        ...
        ; return e.classNameAliases = a(e.classNameAliases || {}), function n(i, r) {
          const o = i
            ...
            ; return "object" == typeof i.keywords && i.keywords.$pattern && (i.keywords = Object.assign({}, i.keywords),
              ...
              i.contains || (i.contains = []), i.contains = [].concat(...i.contains.map((e => (e => (e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map((t => a(e, {
                variants: null
              }, t)))), e.cachedVariants ? e.cachedVariants : V(e) ? a(e, {
                starts: e.starts ? a(e.starts) : null
              }) : Object.isFrozen(e) ? a(e) : e))("self" === e ? i : e)))), i.contains.forEach((e => {
                n(e, o)
              })), i.starts && n(i.starts, r), o.matcher = (e => {
                const t = new s
  ...
  const J = i, Y = a, ee = Symbol("nomatch"); var te = (e => {
    const t = Object.create(null), i = Object.create(null), a = []; let r = !0
      ; const o = "Could not find the language '{}', did you forget to load/include a language module?", l = {
        ...
        let s = "", i = ""
          ...
          ; return r.code = a.code, O("after:highlight", r), r
      } function E(e, n, i, a) {
        const l = Object.create(null); function c() {
          if (!v.keywords) return void S.addText(R)
                ...
                ; const i = y.case_insensitive ? t[0].toLowerCase() : t[0], a = (s = i, v.keywords[s]); if (a) {
                  const [e, s] = a
                    ; if (S.addText(n), n = "", l[i] = (l[i] || 0) + 1, l[i] <= 7 && (M += s), e.startsWith("_")) n += t[0]; else {
                      const n = y.classNameAliases[e] || e; S.addKeyword(t[0], n)
                    }
                } else n += t[0]
                ; e = v.keywordPatternRe.lastIndex, t = v.keywordPatternRe.exec(R)
            } var s
            ; n += R.substr(e), S.addText(n)
        } function u() {
          null != v.subLanguage ? (() => {
          ...
          let n = 1; for (; void 0 !== t[n];) {
            if (!e._emit[n]) {
              n++
                ; continue
            } const s = y.classNameAliases[e[n]] || e[n], i = t[n]
              ; s ? S.addKeyword(i, s) : (R = i, c(), R = ""), n++
          }
        } function h(e, t) {
          return e.scope && "string" == typeof e.scope && S.openNode(y.classNameAliases[e.scope] || e.scope),
            e.beginScope && (e.beginScope._wrap ? (S.addKeyword(R, y.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
              R = "") : e.beginScope._multi && (g(e.beginScope, t), R = "")), v = Object.create(e, {
                parent: {
                  value: v
                }
              }), v
          ...
          return 0 === v.matcher.regexIndex ? (R += e[0], 1) : (T = !0, 0)
        } function f(e) {
        ...
        let m = {}; function w(t, a) {
          const o = a && a[0]; if (R += t, null == o) return u(), 0
            ; if ("begin" === m.type && "end" === a.type && m.index === a.index && "" === o) {
              if (R += n.slice(a.index, a.index + 1), !r) {
            ...
            const t = e[0], n = e.rule, i = new s(n), a = [n.__beforeBegin, n["on:begin"]]
              ; for (const n of a) if (n && (n(e, i), i.isMatchIgnored)) return p(t)
                ; return n.skip ? R += t : (n.excludeBegin && (R += t),
                  u(), n.returnBegin || n.excludeBegin || (R = t)), h(n, e), n.returnBegin ? 0 : t.length
          })(a)
            ; if ("illegal" === a.type && !i) {
              const e = Error('Illegal lexeme "' + o + '" for mode "' + (v.scope || "<unnamed>") + '"')
                ; throw e.mode = v, e
            } if ("end" === a.type) { const e = f(a); if (e !== ee) return e }
          ...
          ; if (!y) throw K(o.replace("{}", e)), Error('Unknown language: "' + e + '"')
            ; const N = q(y); let k = "", v = a || N; const O = {}, S = new d.__emitter(d); (() => {
              const e = []
                ; for (let t = v; t !== y; t = t.parent)t.scope && e.unshift(t.scope)
                  ; e.forEach((e => S.openNode(e)))
            })(); let R = "", M = 0, I = 0, A = 0, T = !1; try {
              for (v.matcher.considerAll(); ;) {
                A++, T ? T = !1 : v.matcher.considerAll(), v.matcher.lastIndex = I
                  ...
                  ; I = e.index + t
              } return w(n.substr(I)), S.closeAllNodes(), S.finalize(), k = S.toHTML(), {
                language: e, value: k, relevance: M, illegal: !1, _emitter: S, _top: v
              }
            } catch (t) {
              if (t.message && t.message.includes("Illegal")) return {
                ...
                illegal: !0, relevance: 0, _illegalBy: {
                  ...
                  context: n.slice(I - 100, I + 100), mode: t.mode, resultSoFar: k
                }, _emitter: S
              }; if (r) return {
        ...
        let t = null; const n = (e => {
          ...
          }), O("after:highlightElement", { el: e, result: a, text: s })
      } let y = !1; function N() {
    ...
    "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
      ...
      highlight: m, highlightAuto: _, highlightAll: N,
      highlightElement: w,
      ...
      }, registerLanguage: (n, s) => {
        let i = null; try { i = s(e) } catch (e) {
      ...
      autoDetection: v, inherit: Y, addPlugin: e => {
        (e => {
      ...
      concat: b, lookahead: u, either: p, optional: h,
      anyNumberOfTimes: g
    ...
    grmr_sway: e => {
      const t = {
        ...
        begin: b(/\b/, /(?!let\b)/, e.IDENT_RE, u(/\s*\(/))
      }, n = "([u](8|16|32|64))?"; return {
        name: "Sway", aliases: ["sw"], keywords: {
          $pattern: e.IDENT_RE + "!?",
        ...
        },
        {
          ...
          begin: [/type/, /\s+/, e.UNDERSCORE_IDENT_RE], className: {
            1: "keyword",
            3: "title.class"
          }
        }, {
    ...
    grmr_ini: e => {
      const t = e.regex, n = {
        ...
        begin: /\[/, end: /\]/, contains: [s, a, i, r, n, "self"], relevance: 0
      }, l = t.either(/[A-Za-z0-9_-]+/, /"(\\"|[^"])*"/, /'[^']*'/); return {
        name: "TOML, also INI", aliases: ["toml"], case_insensitive: !0, illegal: /\S/,
        contains: [s, { className: "section", begin: /\[+/, end: /\]+/ }, {
          begin: t.concat(l, "(\\s*\\.\\s*", l, ")*", t.lookahead(/\s*=\s*[^#\s]/)),
          className: "attr", starts: { end: /$/, contains: [s, o, a, i, r, n] }
        }]
      }
    }, grmr_bash: e => {
      const t = e.regex, n = {}, s = {
