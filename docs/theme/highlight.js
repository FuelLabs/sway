...
const _="[a-zA-Z]\\w*",w="[a-zA-Z_]\\w*",y="\\b\\d+(\\.\\d+)?",x="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",N="\\b(0b[01]+)",O={
begin:"\\\\[\\s\\S]",relevance:0},k={scope:"string",begin:"'",end:"'",
illegal:"\\n",contains:[O]},R={scope:"string",begin:'"',end:'"',illegal:"\\n",
contains:[O]},v=(e,t,n={})=>{const i=s({scope:"comment",begin:e,end:t,
contains:[]},n);i.contains.push({scope:"doctag",
begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",
end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0})
;const r=p("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/)
;return i.contains.push({begin:f(/[ ]+/,"(",r,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),i
},S=v("//","$"),M=v("/\\*","\\*/"),A=v("#","$");var j=Object.freeze({
...
BACKSLASH_ESCAPE:O,APOS_STRING_MODE:k,QUOTE_STRING_MODE:R,PHRASAL_WORDS_MODE:{
begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/
},COMMENT:v,C_LINE_COMMENT_MODE:S,C_BLOCK_COMMENT_MODE:M,HASH_COMMENT_MODE:A,
...
return t?Number(t):(e=>H.includes(e.toLowerCase()))(e)?0:1}const z={},K=e=>{
console.error(e)},W=(e,...t)=>{console.log("WARN: "+e,...t)},G=(e,t)=>{
z[`${e}/${t}`]||(console.log(`Deprecated as of ${e}. ${t}`),z[`${e}/${t}`]=!0)
},X=Error();function Z(e,t,{key:n}){let i=0;const r=e[n],s={},o={}
...
X;Z(e,e.begin,{key:"beginScope"}),e.begin=E(e.begin,{joinWith:""})}})(e),(e=>{
if(Array.isArray(e.end)){
if(e.skip||e.excludeEnd||e.returnEnd)throw K("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
X
;if("object"!=typeof e.endScope||null===e.endScope)throw K("endScope must be object"),
X;Z(e,e.end,{key:"endScope"}),e.end=E(e.end,{joinWith:""})}})(e)}function V(e){
function t(t,n){
...
r.__beforeBegin=null,[L,B,C].forEach((e=>e(r,o))),r.isCompiled=!0;let l=null
...
r=e,i=t),void 0===n&&(n=!0);const s={code:i,language:r};R("before:highlight",s)
;const o=s.result?s.result:E(s.language,s.code,n)
;return o.code=s.code,R("after:highlight",o),o}function E(e,n,r,s){
...
const n=y.classNameAliases[e]||e;v.addKeyword(t[0],n)}}else n+=t[0]
...
;e=E(k.subLanguage,S,!0,R[k.subLanguage]),R[k.subLanguage]=e._top
...
return e.scope&&"string"==typeof e.scope&&v.openNode(y.classNameAliases[e.scope]||e.scope),
e.beginScope&&(e.beginScope._wrap?(v.addKeyword(S,y.classNameAliases[e.beginScope._wrap]||e.beginScope._wrap),
...
let m={};function w(t,s){const a=s&&s[0];if(S+=t,null==a)return u(),0
...
;return S+=a,a.length}const y=N(e)
;if(!y)throw K(a.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const x=V(y);let O="",k=s||x;const R={},v=new g.__emitter(g);(()=>{const e=[]
;for(let t=k;t!==y;t=t.parent)t.scope&&e.unshift(t.scope)
;e.forEach((e=>v.openNode(e)))})();let S="",M=0,A=0,j=0,I=!1;try{
...
;A=e.index+t}return w(n.substr(A)),v.closeAllNodes(),v.finalize(),O=v.toHTML(),{
language:e,value:O,relevance:M,illegal:!1,_emitter:v,_top:k}}catch(t){
if(t.message&&t.message.includes("Illegal"))return{language:e,value:Q(n),
illegal:!0,relevance:0,_illegalBy:{message:t.message,index:A,
context:n.slice(A-100,A+100),mode:t.mode,resultSoFar:O},_emitter:v};if(o)return{
language:e,value:Q(n),illegal:!1,relevance:0,errorRaised:t,_emitter:v,_top:k}
;throw t}}function _(e,n){n=n||g.languages||Object.keys(t);const i=(e=>{
const t={value:Q(e),illegal:!1,relevance:0,_top:l,_emitter:new g.__emitter(g)}
;return t._emitter.addText(e),t})(e),r=n.filter(N).filter(k).map((t=>E(t,e,!1)))
;r.unshift(i);const s=r.sort(((e,t)=>{
if(e.relevance!==t.relevance)return t.relevance-e.relevance
;if(e.language&&t.language){if(N(e.language).supersetOf===t.language)return 1
;if(N(t.language).supersetOf===e.language)return-1}return 0})),[o,a]=s,c=o
...
;if(R("before:highlightElement",{el:e,language:n
...
}),R("after:highlightElement",{el:e,result:s,text:i})}let y=!1;function x(){
...
;return t&&!t.disableAutodetect}function R(e,t){const n=e;s.forEach((e=>{
e[n]&&e[n](t)}))}
"undefined"!=typeof window&&window.addEventListener&&window.addEventListener("DOMContentLoaded",(()=>{
y&&x()}),!1),Object.assign(e,{highlight:m,highlightAuto:_,highlightAll:x,
highlightElement:w,
highlightBlock:e=>(G("10.7.0","highlightBlock will be removed entirely in v12.0"),
G("10.7.0","Please use highlightElement now."),w(e)),configure:e=>{g=Y(g,e)},
initHighlighting:()=>{
...
listLanguages:()=>Object.keys(t),getLanguage:N,registerAliases:O,
...
},e.versionString="11.3.1",e.regex={concat:f,lookahead:u,either:p,optional:h,
anyNumberOfTimes:d};for(const e in j)"object"==typeof j[e]&&n(j[e])
...
literal:["true","false"],
built_in:["bool","char","u8","u16","u32","u64","u128","b256","b512","str","Self"]
