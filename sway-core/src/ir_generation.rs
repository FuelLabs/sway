...
pub fn compile_program<'eng>(
    ...
    match kind {
        ...
        ty::TyProgramKind::Script { entry_function, main_function } => compile::compile_script(
            engines,
            &mut ctx,
            entry_function,
        ...
        ty::TyProgramKind::Predicate { entry_function, main_function } => compile::compile_predicate(
            engines,
            &mut ctx,
            entry_function,
            root.namespace.module(),
