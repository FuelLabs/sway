...
use crate::{
    ...
    language::CallPath,
    Engines, IncludeSelf, SubstTypes, SubstTypesContext, TypeId, TypeInfo, TypeSubstMap,
    UnifyCheck,
};

use super::{Root, TraitMap};
...
pub(crate) fn check_orphan_rules_for_impls(
    ...
    let module = &current_package.current_package_root_module();
