...
pub struct TypeCheckArguments<'a, T> {
    pub checkee: T,
    /// A constant, global namespace consists of the names that are always present, no matter what
    /// module or scope we are currently checking.
    ///
