        ...
        match item {
            ...
            ImplItem::Constant(const_decl) => {
                let const_decl = check!(
                    ...
                    ty::TyConstantDeclaration::error(const_decl.clone()),
                    warnings,
                    errors
                );
...
fn type_check_const_decl(
    ...
    if impld_constant_ids.contains_key(&const_decl.name) {
    ...
    let mut const_decl_signature = match constant_checklist.get(&const_decl.name) {
