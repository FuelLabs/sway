...
use crate::{
    build_config::DbgGeneration, engine_threading::SpannedWithEngines, language::{
        parsed::{self, AstNodeContent, Declaration, FunctionDeclarationKind},
        ty::{self, TyAstNode, TyDecl},
    }, semantic_analysis::TypeCheckContext, BuildTarget, Engines, TypeArgument, TypeInfo, TypeParameter
};
    ...
    'a: 'b,
{
        ...
        T: Parse,
    {
        ...
        let autogenerated_source_id =
            original_source_id.map(|source_id| engines.se().get_associated_autogenerated_source_id(&source_id));
