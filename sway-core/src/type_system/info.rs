...
pub enum TypeInfo {
    ...
    Array(GenericTypeArgument, Length),
    /// Pointers.
    ...
    RawUntypedPtr,
    RawUntypedSlice,
    Ptr(GenericTypeArgument),
    Slice(GenericTypeArgument),
    /// Type aliases.
...
impl TypeInfo {
    ...
    pub fn as_reference(&self) -> Option<(&bool, &GenericTypeArgument)> {
        match self {
            TypeInfo::Ref {
                to_mutable_value,
                referenced_type,
    ...
    pub fn as_slice(&self) -> Option<&GenericTypeArgument> {
