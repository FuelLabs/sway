...
use crate::{
    ...
    semantic_analysis::*,
    type_system::{check_type_is_not_unknown, look_up_type_id, IntegerBits, TypeId, TypeInfo},
};
...
impl FnCompiler {
    ...
    fn compile_intrinsic_function(
        ...
        match kind {
            ...
            Intrinsic::StateStoreWord => {
                ...
                let val_ty = check_type_is_not_unknown(val_exp.return_type, &span).unwrap();
    ...
    fn compile_var_decl(
        ...
        if matches!(
            &check_type_is_not_unknown(body.return_type, &body.span).map_err(|ty_err| {
