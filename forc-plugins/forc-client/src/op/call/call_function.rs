...
use fuels_core::{
    codec::{
        encode_fn_selector, log_formatters_lookup, ABIDecoder, ABIEncoder, DecoderConfig, EncoderConfig, ErrorDetails, LogDecoder
    },
    types::{
...
pub async fn call_function(
    ...
    let error_codes = unified_program_abi.error_codes.map_or(HashMap::new(), |error_codes| {
        error_codes
            .iter()
            .map(|(revert_code, error_details)| (*revert_code, ErrorDetails::new(
