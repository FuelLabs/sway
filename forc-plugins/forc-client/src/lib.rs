...
pub mod default {
    ...
    pub const BETA_2_ENDPOINT_URL: &str = "node-beta-2.fuel.network";
    pub const BETA_3_ENDPOINT_URL: &str = "beta-3.fuel.network";
    pub const BETA_4_ENDPOINT_URL: &str = "beta-4.fuel.network";
