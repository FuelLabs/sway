...
impl MyContract for Contract {
    ...
    fn test_empty_no_return() {}
    fn test_unit(a: ()) -> () { a }
    fn test_u8(a: u8) -> u8 { a }
    fn test_u16(a: u16) -> u16 { a }
    fn test_u32(a: u32) -> u32 { a }
    fn test_u64(a: u64) -> u64 { a }
    fn test_u128(a: U128) -> U128 { a }
    fn test_u256(a: u256) -> u256 { a }
    fn test_b256(a: b256) -> b256 { a }
    fn test_bytes(a: Bytes) -> Bytes { a }
    fn test_str(a: str) -> str { a }
    fn test_str_array(a: str[10]) -> str[10] { a }
    fn test_str_slice(a: []str) -> []str { a }
    ...
    // complex functions
    fn test_struct_with_generic(a: GenericStruct<u32>) -> GenericStruct<u32> { a }
