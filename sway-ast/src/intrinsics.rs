...
impl fmt::Display for Intrinsic {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let s = match self {
            ...
            Intrinsic::StateClearSlots => "state_clear_slots",
            ...
            Intrinsic::StateLoadSlot => "state_load_slot",
            Intrinsic::StateStoreSlot => "state_store_slot",
            Intrinsic::StateUpdateSlot => "state_update_slot",
            Intrinsic::StatePreload => "state_preload",
            Intrinsic::Log => "log",
            Intrinsic::Add => "add",
            Intrinsic::Sub => "sub",
            Intrinsic::Mul => "mul",
...
impl Intrinsic {
    pub fn try_from_str(raw: &str) -> Option<Intrinsic> {
        ...
        Some(match raw {
            ...
            "__state_clear_slots" => StateClearSlots,
            ...
            "__state_load_slot" => StateLoadSlot,
            "__state_store_slot" => StateStoreSlot,
            "__state_update_slot" => StateUpdateSlot,
            "__state_preload" => StatePreload,
            "__log" => Log,
            "__add" => Add,
            "__sub" => Sub,
            "__mul" => Mul,
